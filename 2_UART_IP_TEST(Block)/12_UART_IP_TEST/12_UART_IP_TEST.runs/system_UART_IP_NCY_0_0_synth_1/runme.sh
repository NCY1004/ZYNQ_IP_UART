...
HD_PWD='E:/12_Zynq_mini/12_UART_IP_TEST/12_UART_IP_TEST/12_UART_IP_TEST.runs/system_UART_IP_NCY_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_UART_IP_NCY_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_UART_IP_NCY_0_0.tcl
