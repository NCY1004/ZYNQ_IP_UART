...
-- Date        : Thu Jul 27 13:41:42 2023
-- Host        : Chan-notebook running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/12_Zynq_mini/12_UART_IP_TEST/12_UART_IP_TEST/12_UART_IP_TEST.gen/sources_1/bd/system/ip/system_processing_system7_0_1/system_processing_system7_0_1_sim_netlist.vhdl
...
entity system_processing_system7_0_1_processing_system7_v5_5_processing_system7 is
  ...
  attribute POWER of system_processing_system7_0_1_processing_system7_v5_5_processing_system7 : entity is "<PROCESSOR name={system} numA9Cores={2} clockFreq={666.666666} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={16} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><PLL domain={Processor} vco={1333.333} /><PLL domain={Memory} vco={1066.667} /><PLL domain={IO} vco={1800.000} /><AXI interface={M_AXI_GP0} dataWidth={32} clockFreq={50} usageRate={0.5} />/>";
...
entity system_processing_system7_0_1 is
  ...
  attribute X_CORE_INFO of system_processing_system7_0_1 : entity is "processing_system7_v5_5_processing_system7,Vivado 2022.1";
...
architecture STRUCTURE of system_processing_system7_0_1 is
  ...
  attribute POWER : string;
  attribute POWER of inst : label is "<PROCESSOR name={system} numA9Cores={2} clockFreq={666.666666} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={16} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><PLL domain={Processor} vco={1333.333} /><PLL domain={Memory} vco={1066.667} /><PLL domain={IO} vco={1800.000} /><AXI interface={M_AXI_GP0} dataWidth={32} clockFreq={50} usageRate={0.5} />/>";
  attribute USE_TRACE_DATA_EDGE_DETECTOR : integer;
