...
module s00_couplers_imp_11SE3QO
  ...
  wire auto_pc_to_s00_couplers_BRESP;
  wire auto_pc_to_s00_couplers_BVALID;
  wire [31:0]auto_pc_to_s00_couplers_RDATA;
  wire auto_pc_to_s00_couplers_RREADY;
  wire auto_pc_to_s00_couplers_RRESP;
  ...
  assign auto_pc_to_s00_couplers_BRESP = M_AXI_bresp;
  assign auto_pc_to_s00_couplers_BVALID = M_AXI_bvalid;
  assign auto_pc_to_s00_couplers_RDATA = M_AXI_rdata[31:0];
  assign auto_pc_to_s00_couplers_RRESP = M_AXI_rresp;
  ...
  system_auto_pc_0 auto_pc
       (.aclk(S_ACLK_1),
        ...
        .m_axi_bresp({auto_pc_to_s00_couplers_BRESP,auto_pc_to_s00_couplers_BRESP}),
        .m_axi_bvalid(auto_pc_to_s00_couplers_BVALID),
        .m_axi_rdata(auto_pc_to_s00_couplers_RDATA),
        .m_axi_rready(auto_pc_to_s00_couplers_RREADY),
        .m_axi_rresp({auto_pc_to_s00_couplers_RRESP,auto_pc_to_s00_couplers_RRESP}),
...
module system
  ...
  wire UART_IP_NCY_0_irq;
  wire UART_IP_NCY_0_tx;
  ...
  (* CONN_BUS_INFO = "ps7_0_axi_periph_M00_AXI xilinx.com:interface:aximm:1.0 AXI4LITE BRESP" *) (* DONT_TOUCH *) wire ps7_0_axi_periph_M00_AXI_BRESP;
  ...
  (* CONN_BUS_INFO = "ps7_0_axi_periph_M00_AXI xilinx.com:interface:aximm:1.0 AXI4LITE RRESP" *) (* DONT_TOUCH *) wire ps7_0_axi_periph_M00_AXI_RRESP;
  ...
  assign rx_1 = rx;
  assign tx = UART_IP_NCY_0_tx;
  system_UART_IP_NCY_0_0 UART_IP_NCY_0
       (.ACLK(processing_system7_0_FCLK_CLK1),
        .ARADDR(ps7_0_axi_periph_M00_AXI_ARADDR),
        .ARESETn(rst_ps7_0_50M_peripheral_aresetn),
        .ARREADY(ps7_0_axi_periph_M00_AXI_ARREADY),
        .ARVALID(ps7_0_axi_periph_M00_AXI_ARVALID),
        .AWADDR(ps7_0_axi_periph_M00_AXI_AWADDR),
        .AWREADY(ps7_0_axi_periph_M00_AXI_AWREADY),
        .AWVALID(ps7_0_axi_periph_M00_AXI_AWVALID),
        .BREADY(ps7_0_axi_periph_M00_AXI_BREADY),
        .BRESP(ps7_0_axi_periph_M00_AXI_BRESP),
        .BVALID(ps7_0_axi_periph_M00_AXI_BVALID),
        .RDATA(ps7_0_axi_periph_M00_AXI_RDATA),
        .RREADY(ps7_0_axi_periph_M00_AXI_RREADY),
        .RRESP(ps7_0_axi_periph_M00_AXI_RRESP),
        .RVALID(ps7_0_axi_periph_M00_AXI_RVALID),
        .WDATA(ps7_0_axi_periph_M00_AXI_WDATA),
        .WREADY(ps7_0_axi_periph_M00_AXI_WREADY),
        .WVALID(ps7_0_axi_periph_M00_AXI_WVALID),
        .irq(UART_IP_NCY_0_irq),
        .rx(rx_1),
        .tx(UART_IP_NCY_0_tx));
  ...
  system_system_ila_0_1 system_ila_0
       (.SLOT_0_AXI_araddr(ps7_0_axi_periph_M00_AXI_ARADDR),
        ...
        .SLOT_0_AXI_bresp({ps7_0_axi_periph_M00_AXI_BRESP,ps7_0_axi_periph_M00_AXI_BRESP}),
        ...
        .SLOT_0_AXI_rresp({ps7_0_axi_periph_M00_AXI_RRESP,ps7_0_axi_periph_M00_AXI_RRESP}),
