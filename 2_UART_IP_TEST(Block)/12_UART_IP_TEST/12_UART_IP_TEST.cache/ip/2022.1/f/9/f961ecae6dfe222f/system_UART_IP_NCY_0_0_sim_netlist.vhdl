...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  ...
  signal \cnt_rx[4]_i_2_n_0\ : STD_LOGIC;
  ...
  signal irq_INST_0_i_14_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_TX_current_state[3]_i_8\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \RX_current_state[0]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \RX_current_state[1]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \RX_current_state[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \RX_current_state[3]_i_2\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \RX_next_state_reg[1]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \RX_next_state_reg[3]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \TX_cnt[0]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \TX_cnt[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \TX_cnt[8]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cnt_rx[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cnt_rx[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \cnt_rx[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \cnt_rx[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt_rx[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt_rx[5]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \cnt_rx[8]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of irq_INST_0_i_12 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of irq_INST_0_i_7 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of irq_INST_0_i_8 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of irq_INST_0_i_9 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[0]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[1]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[3]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[4]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[5]_i_1\ : label is "soft_lutpair16";
...
\FSM_sequential_TX_current_state[3]_i_12\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_sequential_TX_current_state[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_sequential_TX_current_state[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \reg2_reg_n_0_[3]\,
      I3 => \reg2_reg_n_0_[13]\,
      I4 => \FSM_sequential_TX_current_state[3]_i_8_n_0\,
...
\FSM_sequential_TX_current_state[3]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
        ...
        port map (
      I0 => \FSM_sequential_TX_current_state[3]_i_11_n_0\,
      I1 => \reg2_reg_n_0_[7]\,
      I2 => \reg2_reg_n_0_[6]\,
      I3 => \reg2_reg_n_0_[26]\,
      I4 => \reg2_reg_n_0_[24]\,
      I5 => \FSM_sequential_TX_current_state[3]_i_12_n_0\,
...
\TX_cnt[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0D"
    )
        port map (
...
\TX_cnt[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0DD0"
    )
        port map (
...
\TX_cnt[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00D200D2000000D2"
    )
        port map (
      I0 => TX_cnt(4),
      I1 => \TX_cnt[5]_i_2_n_0\,
      I2 => TX_cnt(5),
      I3 => \FSM_sequential_TX_current_state[3]_i_3_n_0\,
      I4 => write_2d,
      I5 => write_1d,
      O => \TX_cnt[5]_i_1_n_0\
    );
\TX_cnt[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\cnt_rx[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1001"
    )
        port map (
      I0 => \cnt_rx[8]_i_2_n_0\,
      I1 => \cnt_rx[9]_i_2_n_0\,
      I2 => \cnt_rx[4]_i_2_n_0\,
      I3 => cnt_rx(4),
      O => p_0_in(4)
    );
\cnt_rx[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
irq_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5555555555555FDF"
    )
        port map (
      I0 => irq_INST_0_i_7_n_0,
      I1 => irq_INST_0_i_8_n_0,
      I2 => cnt_rx(4),
      I3 => cnt_rx(1),
      I4 => cnt_rx(5),
      I5 => cnt_rx(6),
...
irq_INST_0_i_13: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
irq_INST_0_i_6: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \reg3_reg_n_0_[27]\,
      I3 => \reg3_reg_n_0_[28]\,
      I4 => irq_INST_0_i_14_n_0,
      O => irq_INST_0_i_6_n_0
    );
irq_INST_0_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
irq_INST_0_i_8: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
irq_INST_0_i_9: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Axi_Slave is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of RSTATE_i_1 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of S_ARREADY_i_1 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of S_AWREADY_i_1 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of S_WREADY_i_1 : label is "soft_lutpair21";
begin
  ARREADY <= \^arready\;
  AWREADY <= \^awready\;
  BRESP <= \<const0>\;
...
U0_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART
     port map (
      ...
      WVALID => WVALID,
      irq => irq,
      \reg3_reg[0]_0\ => \^awready\,
      \reg3_reg[0]_1\ => \^wready\,
      rx => rx,
      tx => tx
    );
