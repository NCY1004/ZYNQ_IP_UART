...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  ...
  signal \cnt_rx[5]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \RX_current_state[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \RX_current_state[1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \RX_current_state[2]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \RX_current_state[3]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \TX_cnt[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \TX_cnt[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \TX_cnt[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \TX_cnt[4]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \TX_cnt[5]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \TX_cnt[8]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \cnt_rx[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt_rx[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cnt_rx[5]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cnt_rx[5]_i_3\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of irq_INST_0_i_7 : label is "soft_lutpair9";
...
\cnt_rx[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0F000F0F000D0000"
    )
        port map (
      I0 => cnt_rx(5),
      I1 => \cnt_rx[5]_i_2_n_0\,
      I2 => \cnt_rx[9]_i_2_n_0\,
      I3 => \cnt_rx[5]_i_3_n_0\,
      I4 => cnt_rx(3),
      I5 => cnt_rx(4),
      O => p_0_in(4)
    );
...
\cnt_rx[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
irq_INST_0_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Axi_Slave is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of RSTATE_i_1 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of S_ARREADY_i_1 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of S_AWREADY_i_1 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of S_WREADY_i_1 : label is "soft_lutpair20";
begin
  ARREADY <= \^arready\;
  AWREADY <= \^awready\;
  BRESP <= \<const0>\;
