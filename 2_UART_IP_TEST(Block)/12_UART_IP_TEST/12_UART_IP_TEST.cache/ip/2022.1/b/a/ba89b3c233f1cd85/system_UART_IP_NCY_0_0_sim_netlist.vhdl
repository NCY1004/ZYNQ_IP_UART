...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  port (
    ...
    WVALID : in STD_LOGIC;
    \reg2_reg[0]_0\ : in STD_LOGIC;
    \reg2_reg[0]_1\ : in STD_LOGIC;
...
\reg3[31]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FBFFFFFF"
    )
        port map (
...
U0_UART: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART
     port map (
      ...
      WVALID => WVALID,
      irq => irq,
      \reg2_reg[0]_0\ => \^wready\,
      \reg2_reg[0]_1\ => \^awready\,
      rx => rx,
      tx => tx
    );
