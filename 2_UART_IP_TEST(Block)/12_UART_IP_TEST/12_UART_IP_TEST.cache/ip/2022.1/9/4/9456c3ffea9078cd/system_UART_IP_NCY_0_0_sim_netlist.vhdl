...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART is
  ...
  signal \cnt_rx[0]_i_1_n_0\ : STD_LOGIC;
  signal \cnt_rx[5]_i_2_n_0\ : STD_LOGIC;
  signal \cnt_rx[7]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_TX_current_state[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_TX_current_state[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_TX_current_state[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_TX_current_state[3]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \RX_next_state_reg[0]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \RX_next_state_reg[1]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \RX_next_state_reg[2]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \RX_next_state_reg[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \RX_next_state_reg[3]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \TX_cnt[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \TX_cnt[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \TX_cnt[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \TX_cnt[4]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \TX_cnt[5]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \TX_cnt[8]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cnt_rx[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cnt_rx[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cnt_rx[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cnt_rx[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cnt_rx[5]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cnt_rx[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cnt_rx[7]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of irq_INST_0_i_10 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of irq_INST_0_i_7 : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[0]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[1]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[3]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[4]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[5]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[6]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \rx_data_reg[7]_i_1\ : label is "soft_lutpair10";
...
\RX_current_state[3]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \cnt_rx[7]_i_2_n_0\,
...
\cnt_rx[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => cnt_rx(1),
      I4 => cnt_rx(4),
      I5 => \cnt_rx[9]_i_2_n_0\,
      O => p_0_in(4)
    );
\cnt_rx[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_rx[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cnt_rx[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5555555555555455"
    )
        port map (
      I0 => \cnt_rx[9]_i_2_n_0\,
      I1 => \cnt_rx[8]_i_3_n_0\,
      I2 => cnt_rx(6),
      I3 => cnt_rx(5),
      I4 => cnt_rx(9),
      I5 => cnt_rx(1),
...
\cnt_rx[8]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000010"
    )
        port map (
      ...
      I2 => cnt_rx(5),
      I3 => cnt_rx(6),
      I4 => \cnt_rx[8]_i_3_n_0\,
      O => \cnt_rx[8]_i_2_n_0\
    );
\cnt_rx[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
